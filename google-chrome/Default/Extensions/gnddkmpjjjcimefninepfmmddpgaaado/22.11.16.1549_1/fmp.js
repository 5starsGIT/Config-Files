...
const url=new URL(window.location.href),jobID=url.searchParams.get("jobID"),dpioID=url.searchParams.get("dpioID"),QRCode=require("qrcode"),debug=require("./debugConsole"),storage=require("./storagePromise"),URLGEN_URL="https://follow-me.directprint.io/genShortUrl/";function generateFollowMeLogin(e){debug("request follow me url");let n=new XMLHttpRequest;n.open("GET",URLGEN_URL+dpioID,!0),n.onload=function(){if(4==n.readyState)if(200===n.status&&n.responseText){const t=JSON.parse(n.responseText).url;QRCode.toDataURL(t,(n,o)=>{e(200,{image64:o,url:t})})}else e(n.status)},n.send(null)}function doCancel(){jobID&&chrome.runtime.sendMessage({command:"cancelJob",jobID})}document.addEventListener("DOMContentLoaded",function(){const e=document.getElementById("dontShowCheck"),n=document.getElementById("loadDiv"),t=document.getElementById("readyDiv"),o=document.getElementById("errorDiv");function d(o){const d=document.getElementById("fmpImageDiv");let c=document.createElement("IMG");c.src=o.image64,d.append(c),document.getElementById("fmpTextDiv").innerHTML=o.url,n.hidden=!0,t.hidden=!1,document.getElementById("printAction").addEventListener("click",function(){debug("check box"),storage.local.set({dontShowFMPPrompt:e.checked}),debug("send message"),jobID&&chrome.runtime.sendMessage({command:"followMeContinue",jobID}),debug("done"),window.close()})}document.getElementById("cancelAction").addEventListener("click",function(){doCancel(),window.close()}),document.getElementById("dontShowText").addEventListener("click",function(){e.checked=!e.checked}),generateFollowMeLogin((e,t)=>{200==e?d(t):function(e){if(n.hidden=!0,o.hidden=!1,e){const n=document.getElementById("errorText");let t=n.innerHTML;t+="status code: "+e,n.innerHTML=t}}(e)})});

},{"./debugConsole":30,"./storagePromise":32,"qrcode":3}],32:[function(require,module,exports){
