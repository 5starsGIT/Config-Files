...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        local wallpaper = "~/Pictures/Wallpapers/purple-penguins.png"
...
globalkeys = gears.table.join(
 ...
 -- Custom key bindings
    ...
    --Brightness
    awful.key({ modkey, "Shift" },      "=",    function () awful.spawn.with_shell("brightnessctl s 5+") end,
    ...
    awful.key({ modkey },           "e",    function () awful.spawn.with_shell("nautilus") end, 
            {description = "Lauch Files", group = "launcher"}),

    -- Shutdown Computer
    awful.key({ modkey, "Control" },            "y",     function () awful.spawn.with_shell("shutdown now") end,
...
awful.spawn.with_shell("home/alex/.config/mouseSettings.sh")
